...
export async function GET(request: Request) {
  ...
  const tipoElectronico = searchParams.get('tipo_electronico')
  ...
  if (tipoElectronico) query = query.eq('tipo_electronico', tipoElectronico)
...
export async function POST(request: Request) {
  ...
  try {
    ...
    if (insertError) {
      console.error('Error creating electronic:', insertError)
