...
export async function GET(request: Request) {
  ...
  const tipoMueble = searchParams.get('tipo_mueble')
  ...
  if (tipoMueble) query = query.eq('tipo_mueble', tipoMueble)
...
export async function POST(request: Request) {
  ...
  try {
    ...
    if (insertError) {
      console.error('Error creating furniture:', insertError)
