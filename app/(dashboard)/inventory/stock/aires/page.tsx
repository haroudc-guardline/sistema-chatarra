                    ...
                    <table className="w-full">
                      ...
                      <tbody>
                        {items.map((item: StockAcUnit) => (
                          <tr key={item.id} className="border-b border-slate-50 hover:bg-slate-50 transition-colors cursor-pointer" onClick={() => router.push(`/inventory/stock/aires/${item.id}`)}>
